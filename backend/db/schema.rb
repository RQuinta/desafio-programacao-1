...
ActiveRecord::Schema.define(version: 8) do
  ...
  create_table "access_codes", id: :serial, force: :cascade do |t|
    ...
    t.index ["client_id"], name: "index_access_codes_on_client_id"
    t.index ["resource_owner_id"], name: "index_access_codes_on_resource_owner_id"
    t.index ["token"], name: "index_access_codes_on_token", unique: true
  end
